...
public class MainTest {
  ...
  public void testSolution() {
    assertTrue(Main.pi4j.hasProvider(String.valueOf(PiGpioDigitalInputProvider.newInstance(Main.piGpio))));

    assertFalse(Main.pi4j.hasProvider(String.valueOf(PiGpioDigitalOutputProvider.newInstance(Main.piGpio))));
